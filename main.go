...
//returns path, file ext, help flag status and debug flag status (opening file without reading settings)
...
func runTextEditor() error {
    //ensuring existence of settings file
    err := huesettings.CreateInternalSettingsFileIfNotExists()
    if err != nil {
